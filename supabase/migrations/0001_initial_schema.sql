...
-- Source: docs/SCHEMA.sql, applied verbatim. That file is the spec's record of the
-- data shape; this file is the forward-only migration that realises it. Do not edit
-- either one to change the schema — add a new migration.
